...
<div class="page-header">
    <div class="page-header-bg" style="background-image: url('{{ asset('frontend/img/header-list.png') }}');"
        data-stellar-background-ratio="0.5"></div>
    <div class="container">
        <div class="row">
            <div class="col-md-offset-1 col-md-10 text-center">
                <h1 class="text-uppercase">List Post</h1>
            </div>
        </div>
    </div>
</div>
...
<div class="post post-row">
    <a class="post-img" href="{{ route('blog.isi', $list_post->slug) }}"><img src="{{ asset($list_post->image) }}" alt="{{ $list_post->judul }}"></a>
    <div class="post-body">
        ...
        <ul class="post-meta">
            ...
            <li>{{ \Carbon\Carbon::parse($list_post->created_at)->translatedFormat('d F Y') }}</li>
        </ul>
